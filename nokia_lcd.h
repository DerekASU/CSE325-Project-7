...
typedef enum { 
	nokia_lcd_mode_cmd = 0, 
	nokia_lcd_mode_data = 1 
} nokia_lcd_mode_t;

typedef enum { 
	nokia_lcd_reset_asserted = 0, 
	nokia_lcd_reset_deasserted = 1 
} nokia_lcd_reset_t;


/*static uint8_t g_font_table[][5] = {
...
void nokia_lcd_cfg_dc(nokia_lcd_mode_t);
void nokia_lcd_cfg_reset(nokia_lcd_reset_t);
void nokia_lcd_clr();
void nokia_lcd_disp_char(char);
void nokia_lcd_disp_char_xy(int, int, char);
void nokia_lcd_init();
void nokia_lcd_set_x(int);
void nokia_lcd_set_x_char(int);
void nokia_lcd_set_xy(int, int);
void nokia_lcd_set_xy_char(int, int);
void nokia_lcd_set_y(int);
void nokia_lcd_set_y_char(int);
void nokia_lcd_tx(nokia_lcd_mode_t, uint8_t);
